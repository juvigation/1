...
public class TableActivity extends Activity {
    ...
    Integer[] numBtnIDs = {R.id.BtnNum5,R.id.BtnNum6,R.id.BtnNum7,
            R.id.BtnNum8,R.id.BtnNum9, R.id.BtnNum10,R.id.BtnNum11,
            R.id.BtnNum12};
    int i;
    //dialog 변수
    TextView tvName,tvPhone, tvsick; //보여지는 텍스트
    EditText dlgEdtName,dlgEdtPhone,dlgEdtSick; //dialg박스에 입력 받는 부분
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvsick =(TextView)findViewById(R.id.tvSick);
                ...
                dlg.setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                dlgEdtSick=(EditText)dialogView.findViewById(R.id.dlgEdt3);

                                tvName.setText(dlgEdtName.getText().toString());
                                tvPhone.setText(dlgEdtPhone.getText().toString());
                                tvsick.setText(dlgEdtSick.getText().toString());
            ...
            numButtons[index].setOnClickListener(new View.OnClickListener(){
                public void onClick(View view){
                    ...
                    if (index<7){
                        ...
                        personnel.setTextColor(Color.BLUE);
                        Toast.makeText(getApplicationContext(),
                                "4인"+(index+1)+"시간을 선택하셨습니다.",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }//for문 끝
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(seat.length() <= 0 || tvName.length() <= 0 || tvPhone.length() <= 0 ){ //좌석 정보 없으면 인원 정보도 없는 것
                    ...
                    if(seat.length() <= 0){
                        Toast.makeText(getApplicationContext(),"시간와 날짜를 선택하세요"
                                ,Toast.LENGTH_SHORT).show();
                    }
